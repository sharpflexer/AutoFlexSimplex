...
namespace AF_RobotService.Factories
{
    public class OrderFactory
    {
        ...
        public static FuturesOrder GetEnterLongOrder()
        {
            ...
            FuturesOrder order = new FuturesOrder(side, position, execution, status, limits);
            return order;
        }

        public static FuturesOrder GetEnterShortOrder()
        {
            ISide side = new SideEnter();
        ...
        public static FuturesOrder GetFullExitLongOrder()
        {
        ...
        public static FuturesOrder GetPartialExitLongOrder(decimal quantity)
        {
            ISide side = new SideExit();
            IPosition position = new PositionLong();
            IExecution execution = new ExecutionPartialOneTime(quantity);
            IStatus status = new StatusEnter();
            FuturesOrder order = new FuturesOrder(side, position, execution, status, null);
            return order;
        }

        public static FuturesOrder GetFullExitShortOrder()
        {
            ISide side = new SideExit();
            IPosition position = new PositionShort();
            IExecution execution = new ExecutionFullOneTime();
        ...
        public static FuturesOrder GetPartialExitShortOrder(decimal quantity)
        {
            ISide side = new SideExit();
            IPosition position = new PositionShort();
            IExecution execution = new ExecutionPartialOneTime(quantity);
        ...
        public static FuturesOrder GetStopLossLongOrder()
        {
            ISide side = new SideExit();
            IPosition position = new PositionLong();
            IExecution execution = new ExecutionFullOneTime();
        ...
        public static FuturesOrder GetStopLossShortOrder()
        {
            ISide side = new SideExit();
            IPosition position = new PositionShort();
            IExecution execution = new ExecutionFullOneTime();
        ...
        public static FuturesOrder GetTakeProfitLong()
        {
            ISide side = new SideExit();
            IPosition position = new PositionLong();
        ...
        public static FuturesOrder GetTakeProfitShort()
        {
            ISide side = new SideExit();
            IPosition position = new PositionShort();
            IExecution execution = new ExecutionPartialOneTime(60);
